...
export default function KitchenPage() {
  ...
  if (status === 'loading' || !session || session.user?.role !== 'kitchen') {
    return <div className="min-h-screen bg-gray-50 flex items-center justify-center text-xl text-gray-500">Loading Kitchen System...</div>;
  }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto">
        <div className="flex flex-col">
          <h2 className="text-lg font-bold mb-3 text-red-600 flex items-center gap-2">🔴 New Orders ({newOrders.length})</h2>
        ...
        <div className="flex flex-col">
          <h2 className="text-lg font-bold mb-3 text-orange-600 flex items-center gap-2">🟠 Preparing ({activeOrders.length})</h2>
          <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col">
          <h2 className="text-lg font-bold mb-3 text-green-600 flex items-center gap-2">🟢 Delivered ({completedOrders.length})</h2>
